...
export function AVenirLigne({ match, clubsById, to }) {
  ...
  return (
    <Link to={to || `/matchs/${match.id}`} className="bulletin-row">
      ...
      <span className="bulletin-logos" aria-hidden="true">
        <span className="bulletin-logo">
          {clubsById[match.equipe_domicile_id]?.logo_url ? (
            <img src={clubsById[match.equipe_domicile_id].logo_url} alt="" />
          ) : null}
        </span>
        <span className="bulletin-logo">
          {clubsById[match.equipe_exterieur_id]?.logo_url ? (
            <img src={clubsById[match.equipe_exterieur_id].logo_url} alt="" />
          ) : null}
        </span>
      </span>
